...
TRAIN_DATASET_PATH = '/content/drive/MyDrive/BRATS_Segmentation/BRATS/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/'
...
t2_list = sorted(glob.glob('/content/drive/MyDrive/BRATS_Segmentation/BRATS/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*t2.nii'))
t1ce_list = sorted(glob.glob('/content/drive/MyDrive/BRATS_Segmentation/BRATS/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*t1ce.nii'))
flair_list = sorted(glob.glob('/content/drive/MyDrive/BRATS_Segmentation/BRATS/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*flair.nii'))
mask_list = sorted(glob.glob('/content/drive/MyDrive/BRATS_Segmentation/BRATS/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*seg.nii'))
